...
#include <vector>
#include <memory>
#include "GLViewTestModule.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewTestModule > glView( Aftr::GLViewTestModule::New( args ) );
